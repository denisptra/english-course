      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-[#1E1E1E] mb-6 leading-tight">
            ...
            <span className="block text-[#20438F]">With Confidence</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-[#1E1E1E] mb-8 max-w-3xl mx-auto leading-relaxed">
            Join a course designed for beginners 17+ who want to master English step by step.
          </p>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="text-[#1E1E1E]">Age Requirement</div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="text-3xl font-bold text-[#20438F] mb-2">3</div>
              <div className="text-[#1E1E1E]">Course Programs</div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="text-3xl font-bold text-[#20438F] mb-2">100%</div>
              <div className="text-[#1E1E1E]">Beginner Friendly</div>
            </div>
          </div>
        </div>
      </div>
